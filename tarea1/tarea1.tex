...
\end{enumerate}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}9}]:} \PY{k+kn}{from} \PY{n+nn}{sklearn.preprocessing} \PY{k+kn}{import} \PY{n}{StandardScaler}
...
\end{enumerate}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}10}]:} \PY{k+kn}{import} \PY{n+nn}{sklearn.linear\PYZus{}model} \PY{k+kn}{as} \PY{n+nn}{lm}
...
\end{Verbatim}
            ...
            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}10}]:} LinearRegression(copy\_X=True, fit\_intercept=False, n\_jobs=1, normalize=False)
\end{Verbatim}
...
\end{enumerate}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}11}]:} \PY{c+c1}{\PYZsh{} Correlacion entre variables}
...
\end{Verbatim}
            ...
            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}11}]:}            Coefficent  Std. Error   Z-score
...
\end{enumerate}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}12}]:} \PY{c+c1}{\PYZsh{} Predecir en el testing set y training set}
         \PY{n}{yhat\PYZus{}test} \PY{o}{=} \PY{n}{linreg}\PY{o}{.}\PY{n}{predict}\PY{p}{(}\PY{n}{Xtest}\PY{p}{)}
         \PY{n}{yhat\PYZus{}train} \PY{o}{=} \PY{n}{linreg}\PY{o}{.}\PY{n}{predict}\PY{p}{(}\PY{n}{Xtrain}\PY{p}{)}
...
\itemsep1pt\parskip0pt\parsep0pt
\item
  QQ Plot para error de prueba. Podemos observar que \(R^2 = 0.9902\),
...
{\color{incolor}In [{\color{incolor}23}]:} \PY{o}{\PYZpc{}}\PY{k}{matplotlib} inline
         ...
         \PY{n}{residual} \PY{o}{=} \PY{n}{yhat\PYZus{}train} \PY{o}{\PYZhy{}} \PY{n}{ytrain}
         \PY{n}{plt}\PY{o}{.}\PY{n}{figure}\PY{p}{(}\PY{n}{figsize}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{6}\PY{p}{,}\PY{l+m+mi}{6}\PY{p}{)}\PY{p}{)}
         \PY{n}{d1}\PY{p}{,} \PY{n}{d2} \PY{o}{=} \PY{n}{stats}\PY{o}{.}\PY{n}{probplot}\PY{p}{(}\PY{n}{residual}\PY{p}{,} \PY{n}{dist}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{norm}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{plot}\PY{o}{=}\PY{n}{plt}\PY{p}{)}
         \PY{k}{print} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{R\PYZca{}2=}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}\PY{n}{d2}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]}
...
R\^{}2= 0.990277677828
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{tarea1_files/tarea1_15_1.png}
    \end{center}
    { \hspace*{\fill} \\}
...
\item
  ...
  el codigo, modifique las lineas 7 y 9 del ejemplo anterior. Construya
...
\end{enumerate}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}25}]:} \PY{k+kn}{import} \PY{n+nn}{os.path}
...
\end{enumerate}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}26}]:} \PY{n}{X\PYZus{}train}\PY{o}{.}\PY{n}{get\PYZus{}shape}\PY{p}{(}\PY{p}{)}
\end{Verbatim}

            \begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}26}]:} (1147, 145256)
\end{Verbatim}
        
    Se observa que hay 1147 peliculas cada una con 145256 atributos.

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}27}]:} \PY{c+c1}{\PYZsh{}from sklearn.preprocessing import StandardScaler}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}28}]:} \PY{k+kn}{from} \PY{n+nn}{sklearn.feature\PYZus{}selection} \PY{k+kn}{import} \PY{n}{SelectKBest}\PY{p}{,} \PY{n}{chi2}
